...
public class Step0_sqlTableToCsv
{
    public static void Start()
    {
        ...
        var zfkd_qscore = new List<object> {
            //  "[meta]dim_GKZ_1_Inkar"
            // ,"[meta]dim_GKZ_1_LK"
            // ,"[meta]dim_GKZ_2_BRD_DDR"
            // ,"[meta]dim_GKZ_2_RB"
            // ,"[meta]dim_GKZ_2_RO"
            // ,"[meta]dim_GKZ_3_BL"
            // ,"[meta]dim_GKZ_3_BL_NRW_MS"
            // ,"[meta]dim_GKZ_3_EKR"
            // ,"[meta]dim_GKZ_3_REG"
            // ,"[meta]dim_GKZ_3_Vollz"
            // ,"[meta]dim_GKZ_5_Laender"
            // ,"[meta]dim_GKZ_6_EU"
            // ,"[meta]dim_Date"
            "[meta]dim_ICDO3"
            };
        ...
        {
            // zfkd_meta.ForEach(x => { convert(Globals.db_zfkd_meta, x); });
